...
namespace aro_hotel.Domain.Migrations
{
    ...
    [Migration("20221001191536_MultimediaXREFAdded")]
    partial class MultimediaXREFAdded
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("aro_hotel.Domain.Model.HotelMultimediaXREF", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("aro_hotel.Domain.Model.RoomMultimediaXREF", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("aro_hotel.Domain.Model.HotelMultimediaXREF", b =>
                {
                    b.HasOne("aro_hotel.Domain.Model.Hotel", "Hotel")
                        .WithMany("HotelMultimediaXREFs")
                        .HasForeignKey("HotelId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();

                    b.HasOne("aro_hotel.Domain.Model.Multimedia", "Multimedia")
                        .WithMany("HotelMultimediaXREFs")
            ...
            modelBuilder.Entity("aro_hotel.Domain.Model.Hotel", b =>
                {
                    ...
                    b.Navigation("HotelMultimediaXREFs");
            ...
            modelBuilder.Entity("aro_hotel.Domain.Model.Multimedia", b =>
                {
                    ...
                    b.Navigation("RoomMultimediaXREFs");
                });
